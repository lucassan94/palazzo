    ...
    <div class="content">
      ...
      <div v-if="currentTab === 'financeiro'">
        ...
        <div class="stats-grid" style="grid-template-columns:repeat(3,1fr);">
          <div class="stat-card"><div class="label">Hoje</div><div class="value" style="font-size:1.1rem;">{{ formatPrice(financeiro.hoje) }}</div></div>
          <div class="stat-card"><div class="label">Semana</div><div class="value" style="font-size:1.1rem;">{{ formatPrice(financeiro.semana) }}</div></div>
          <div class="stat-card"><div class="label">Mês</div><div class="value" style="font-size:1.1rem;">{{ formatPrice(financeiro.mes) }}</div></div>
        </div>
      </div>
...
const financeiro = ref({ hoje: 0, semana: 0, mes: 0 })
...
async function loadData() {
  try {
    ...
    financeiro.value = e.data.financeiro || { hoje: 0, semana: 0, mes: 0 }
